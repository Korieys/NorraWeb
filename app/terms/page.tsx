...
export default function TermsPage() {
  return <main className="mx-auto max-w-3xl px-6 py-16 font-sans text-ink">
    ...
    <div className="mt-10 space-y-8 text-sm leading-7 text-ink/80">
      ...
      <section><h2 className="font-semibold text-ink">Product information</h2><p>The current pilot Daypack contains nine individual shelf-stable items: a Kodiak Chocolate Chip Protein Muffin Power Cup; Quest Strawberry and Chocolate Protein Milkshakes; two HMR entrées from a rotating selection; a Legendary Blueberry Protein Tasty Pastry; a think! 20g Protein Bar; and two H-E-B Hit the Trail Mix packets. The working nutrition target is 170g+ protein and approximately 2,000–2,100 calories; exact totals depend on the entrée pair. Final ingredients, allergens, nutrition, storage, and preparation directions are stated on the received manufacturer labels. We will notify you of material changes before shipment and provide an opportunity to cancel for a full refund.</p></section>
